...
import RiskCalculatorScreen from '../screens/RiskCalculator';
import BrokerConnectScreen from '../screens/Broker/BrokerConnect';
import TradeConfirmScreen from '../screens/Broker/TradeConfirm';
...
function JournalIcon({ color, size }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M4 19.5C4 18.1 5.1 17 6.5 17H20M4 19.5C4 20.9 5.1 22 6.5 22H20V2H6.5C5.1 2 4 3.1 4 4.5V19.5Z"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
function AuthNavigator() {
  ...
  return (
    <AuthStack.Navigator
      ...
      initialRouteName={completed ? 'Login' : 'Login'}
    >
...
function HomeNavigator() {
  return (
    ...
    >
      ...
      <HomeStack.Screen name="SignalDetail" component={SignalDetailScreen} />
    </HomeStack.Navigator>
  );
}
    ...
    <AppTabs.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size, focused }) => {
          const props = { color, size, focused };
          switch (route.name) {
            case 'HomeTab':
